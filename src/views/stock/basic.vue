  ...
  <div class="tab-container">
    ...
    <el-tabs v-model="activeName" @tab-click="handleTabClick">
      <el-tab-pane label="company" name="company">
        <BasicCompany @company_multiple_selection="listenCompanySelection" :deleteSelection="delete_selection" />
      </el-tab-pane>
      <el-tab-pane label="index" name="index">
        <BasicIndex @index_multiple_selection="listenIndexSelection" :deleteSelection="delete_selection" />
      </el-tab-pane>
    </el-tabs>
...
import BasicCompany from './basic_company'
import BasicIndex from './basic_index'
