<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column fixed prop="ts_code" sortable="custom" align="center" :label="$t('table.daily_index.ts_code')" :class-name="getSortClass('ts_code')" width="110">
        <template slot-scope="scope">
          <!--{{ scope.$index }}-->
          {{ scope.row.ts_code }}
        </template>
      </el-table-column>
      <el-table-column fixed prop="name" :label="$t('table.daily_index.name')" :class-name="getSortClass('name')">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
      <el-table-column sortable prop="trade_date" :label="$t('table.daily_index.trade_date')">
        <template slot-scope="scope">
          <span>{{ scope.row.trade_date }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="close" :label="$t('table.daily_index.close')">
        <template slot-scope="scope">
          <span>{{ scope.row.close }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="open" :label="$t('table.daily_index.open')">
        <template slot-scope="scope">
          <span>{{ scope.row.open }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="high" :label="$t('table.daily_index.high')">
        <template slot-scope="scope">
          <span>{{ scope.row.high }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="low" :label="$t('table.daily_index.low')">
        <template slot-scope="scope">
          <span>{{ scope.row.low }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="pre_close" :label="$t('table.daily_index.pre_close')">
        <template slot-scope="scope">
          <span>{{ scope.row.pre_close }}</span>
        </template>
      </el-table-column>

      <el-table-column sortable prop="change" :label="$t('table.daily_index.change')">
        <template slot-scope="scope">
      ...
      <el-table-column sortable prop="pct_chg" :label="$t('table.daily_index.pct_chg')">
        <template slot-scope="scope">
      ...
      <el-table-column sortable prop="vol" :label="$t('table.daily_index.vol')">
        <template slot-scope="scope">
          <span>{{ scope.row.vol }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="amount" :label="$t('table.daily_index.amount')">
        <template slot-scope="scope">
