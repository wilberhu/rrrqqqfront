      ...
      <el-form label-width="90px">
        ...
        <el-form-item>
          <el-date-picker
            ...
            :clearable="false"
            :editable="false"
            style="width: 100%; max-width: 220px; margin: 5px;"
            aria-required="true"
            placeholder="选择日期"
            @blur="refreshChart()"
          >
          </el-date-picker>
          <el-input type="number" readonly placeholder="value" v-model="compositionForm.allfund" style="width: 100%; max-width: 220px; margin: 5px;">
            <template slot="prepend">资金总额</template>
          </el-input>
          <el-input type="number" readonly placeholder="value" v-model="compositionForm.commission" style="width: 100%; max-width: 220px; margin: 5px;">
